...
const W2_FIELD_DEFS: { key: string; label: string; type: 'monetary' | 'text' }[] = [
  ...
  { key: 'box12a_code', label: 'Box 12a — Code', type: 'text' },
  { key: 'box12a_amount', label: 'Box 12a — Amount', type: 'monetary' },
  { key: 'box12b_code', label: 'Box 12b — Code', type: 'text' },
  { key: 'box12b_amount', label: 'Box 12b — Amount', type: 'monetary' },
  { key: 'box12c_code', label: 'Box 12c — Code', type: 'text' },
  { key: 'box12c_amount', label: 'Box 12c — Amount', type: 'monetary' },
  { key: 'box12d_code', label: 'Box 12d — Code', type: 'text' },
  { key: 'box12d_amount', label: 'Box 12d — Amount', type: 'monetary' },
